/* Create the database */
DROP DATABASE IF EXISTS tv_reviews;
CREATE DATABASE IF NOT EXISTS tv_reviews;
USE tv_reviews;
...
/* Display the titles and ratings of each tv show */
SELECT 
  series.title, 
  reviews.rating 
FROM series
...
/* Display all shows titles with their average rating */
SELECT 
  series.title, 
...
/* Display all reviewers names and ratings */
SELECT 
...
/* Display all genres and their average ratings */
SELECT
  series.genre,
...
/* Display list of authors with the amount of series they have active + the min, max and avg ratings */
SELECT
  reviewers.first_name,
  reviewers.last_name,
...
/* Display the title of each series with their respective rating and reviewer */
SELECT
  series.title,
  reviews.rating,
